    ...
    <header class="site-header">
      <nav class="site-nav">
        ...
        <div class="header-actions hidden md:flex">
          ...
          <a href="https://calendly.com/squadtechsolution/inquiry" class="primary-button magnetic-button" target="_blank" rel="noreferrer">Start a Project</a>
        </div>
      </nav>
      <div id="mobile-menu" class="mobile-menu md:hidden">
        <div class="mobile-links">
          ...
          <a href="https://calendly.com/squadtechsolution/inquiry" class="primary-button" target="_blank" rel="noreferrer">Start a Project</a>
          </div>
        </div>
      </div>
    </header>
